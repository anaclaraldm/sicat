...
- Python – linguagem utilizada no desenvolvimento do back-end do sistema
- Flask – framework web em Python responsável pela lógica do sistema e rotas da aplicação
- HTML5 – estrutura das páginas web
- CSS3 – estilização e layout da interface do sistema
- GitHub – hospedagem e versionamento do código-fonte durante o desenvolvimento
- GitLab – gerenciamento do repositório e integração com pipelines de deploy
- Docker – containerização da aplicação, facilitando o deploy e a padronização do ambiente
